namespace osuTools.Beatmaps
{
    ...
    /// 表示一个休息时间。
    /// </summary>
    public class BreakTime : IOsuFileContent
    {
        /// <summary>
        /// 开始时间，以毫秒为单位
        /// </summary>
        ...
        static BreakTime empty = null;
       
        public static BreakTime Empty { get { if (empty is null) empty = new BreakTime(0, 0); return empty; } }
