...
namespace osuTools.Game.Modes
{
    ...
    public class CatchMode : GameMode, ILegacyMode
    {
        ...
        /// </summary>
        /// <param name="b"></param>
        public void SetBeatmap(Beatmap b) => _innerBeatmap = new CatchBeatmap(b);

        /// <inheritdoc/>
        public override int GetBeatmapMaxCombo(ScoreInfo info) =>
            _performanceCalculator.Beatmap.MaxCombo;
        ///<inheritdoc/>
        public override double GetHitObjectPercent(ScoreInfo info) =>
