namespace osuTools.Beatmaps.HitObject
{
    ...
    /// 表示一个Mania长条
    /// </summary>
    public class ManiaHold:IHitObject
    {
        /// <summary>
        /// 打击物件的类型
        /// </summary>
        ...
        /// 此属性对长条无效
        /// </summary>
        public OsuPixel Position { get; private set; } = new OsuPixel(0, 0);
        /// <summary>
        /// 音效类型
        /// </summary>
       ...
       /// 谱面键位数
       /// </summary>
        public int BeatmapColumn { get; private set; } = 0;
        ...
        {
            return $"{Position.x},{Position.y},{Offset},{type},{(int)HitSound},{EndTime}:{HitSample.GetData()}";
        }
    }
}